...
export HYPERNET_PATH="models/hypernet.pth"
export LORAS_HOME="loras"
export SAVE_PATH="generated_images/lorarar"
...
do
        ...
        CUDA_VISIBLE_DEVICES=0 python inference_lorarar.py --N 10 --lora1 $LORAS_HOME/subjects/$subject \
